...
public interface ITaskService {
    ...
    @Nullable
    TaskDTO findTask(@NotNull final String id, @NotNull final String userId);

    @NotNull
    Collection<TaskDTO> findAll(@NotNull final String userId);

    @NotNull
    Collection<TaskDTO> findAllName(@NotNull final String findParameter, @NotNull final String userId);

    @NotNull
    Collection<TaskDTO> findAllDescription(@NotNull final String findParameter, @NotNull final String userId);
