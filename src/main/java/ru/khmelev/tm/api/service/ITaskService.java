...
public interface ITaskService {
    ...
    @NotNull Collection<TaskDTO> findAll(@NotNull final String userId);

    @NotNull Collection<TaskDTO> findAllName(@NotNull final String findParameter, @NotNull final String userId);

    @NotNull Collection<TaskDTO> findAllDescription(@NotNull final String findParameter, @NotNull final String userId);

    void removeTask(@NotNull final String id, @NotNull final String userId);

    void clearTask(@NotNull final String userId);

    @NotNull Collection<TaskDTO> listTaskFromProject(@NotNull final String projectId, @NotNull final String userId);
}